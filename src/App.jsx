  ...
  return (
    <div className="app-container">
      ...
      <div style={{ height: '600px', position: 'relative' }}>
        ...
        >
        <Card className="card">
            <h3 style={{ margin: "10px", color: "white", textAlign: "left", paddingLeft: "10px" }}>
              Slide 1
            </h3>
            <img
              src="https://integralwebsolution.com/wp-content/uploads/2020/03/custom-template-banner3.jpg"
              alt="Slide 1"
              style={{ width: "100%", padding: "20px", borderRadius: "12px 12px 12px 12px" }}
            /> 
        </Card>
      ...
      <Card>
        ...
        <img
          ...
          alt="Slide 2"
          style={{ width: "100%", padding:"20px", borderRadius: "12px 12px 0 0" }}
        />
      </Card>
